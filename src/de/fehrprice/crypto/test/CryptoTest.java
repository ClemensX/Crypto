...
public class CryptoTest {
	...
	@Test public void testAES() {
        ...
        byte[] key128 = {(byte)0x2b, (byte)0x7e, (byte)0x15, (byte)0x16, (byte)0x28, (byte)0xae, (byte)0xd2, (byte)0xa6, (byte)0xab, (byte)0xf7, (byte)0x15, (byte)0x88, (byte)0x09, (byte)0xcf, (byte)0x4f, (byte)0x3c};
        //byte[] key128 = {(byte)0x2b, (byte)0x28, (byte)0xab, (byte)0x09, (byte)0x7e, (byte)0xae, (byte)0xf7, (byte)0xcf, (byte)0x15, (byte)0xd2, (byte)0x15, (byte)0x4f, (byte)0x16, (byte)0xa6, (byte)0x88, (byte)0x3c};
        byte[] crypt1 = aes.cipher(key128, plaintext, Nb, 10, 4, w);
        byte[] res1 = {(byte)0x39, (byte)0x02, (byte)0xdc, (byte)0x19, (byte)0x25, (byte)0xdc, (byte)0x11, (byte)0x6a, (byte)0x84, (byte)0x09, (byte)0x85, (byte)0x0b, (byte)0x1d, (byte)0xfb, (byte)0x97, (byte)0x32};
        for (int i = 0; i < res1.length; i++) {
        	assertEquals(res1[i], crypt1[i]);
        }
		
		byte[] plaintext_2 = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, (byte)0x88, (byte)0x99, (byte)0xaa, (byte)0xbb, (byte)0xcc, (byte)0xdd, (byte)0xee, (byte)0xff};
        byte[] key128_2 = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f};
        ...
        //String zeroKey = "000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f";
	...
	@Test public void testKeyExpansion() {
		...
		byte[] key192 = {(byte)0x8e, 0x73, (byte)0xb0, (byte)0xf7, (byte)0xda, 0x0e, 0x64, 0x52, (byte)0xc8, 0x10, (byte)0xf3, 0x2b,
		...
		byte[] key256 = {0x60, 0x3d, (byte)0xeb, 0x10, 0x15, (byte)0xca, 0x71, (byte)0xbe, 0x2b, 0x73, (byte)0xae, (byte)0xf0, (byte)0x85, 0x7d, 0x77, (byte)0x81,
...
//		}
	...
	private double calculatePi(AES aes, long num_points) {
		...
		for (long i = 0; i < num_points; i++) {
			...
			//System.out.println("x y all inside " + Long.toHexString(x) + " " + Long.toHexString(y) + " " + Num_all + " " + Num_square + " " + dist_2d + " " + r2d);
		}
